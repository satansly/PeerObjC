...
-(instancetype)init __attribute__((unavailable("init is not a supported for OGConnection. Use OGConnection subclass"))){
    return nil;
}
-(void)initialize __attribute__((unavailable("initializer is not a supported for OGConnection. Use OGConnection subclass"))){
    
}
-(void)handleError:(NSError *)error __attribute__((unavailable("handleError is not a supported for OGConnection. Use OGConnection subclass"))){
