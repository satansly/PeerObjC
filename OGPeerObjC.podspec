#
#  Be sure to run `pod spec lint OGPeerObjC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/OGPeerObjC"
  ...
  # Or just: s.author    = "Omar Hussain"
  # s.authors            = { "Omar Hussain" => "satansly@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Omar Hussain"
